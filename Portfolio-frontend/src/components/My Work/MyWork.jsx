...
const about = {
  description:
    "I’m driven by curiosity, resilience, and a calm determination to solve problems that others walk away from.",
  floating_captions: [
  ...
  resume_link:
    "https://drive.google.com/file/d/1imm00dKuLfCd3wIscZaaBDfQlwCk9L3e/view?usp=drive_link",
};
const home = {
  name: "Pravin Kumar",
  intro: "Hi Viewers,",
  ...
  avatar_img:
    "https://my-personal-s3-bucket-portfolio.s3.ap-south-1.amazonaws.com/Projects+/User+Avatar/IMG_20220418_223644-min.jpg",
  paragraph:
  ...
  asset_id:
    "https://my-personal-s3-bucket-portfolio.s3.ap-south-1.amazonaws.com/Projects+/Work+Experience+gif-image+related+to+your+work/code+for+life.gif",
};
